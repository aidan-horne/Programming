...
public class KnoxAPI {
    ...
    */
    ...
    public static HttpURLConnection connect(String token, String id, String apiUrl, String params) throws IOException {
    ...
    public static String[] getProperties(List<String> list) throws FileNotFoundException {
        ...
        try (FileReader fileReader = new FileReader("config.properties.txt")) {
            ...
            String signedAccessToken = KnoxTokenUtility.generateSignedAccessTokenJWT(new FileInputStream(cert), signedClientID);
